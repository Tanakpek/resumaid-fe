...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ref={ref}
    className={cn(
      "tw-flex tw-cursor-default tw-gap-2 tw-select-none tw-items-center tw-rounded-sm tw-px-2 tw-py-1.5 tw-text-sm tw-outline-none focus:tw-bg-slate-100 data-[state=open]:tw-bg-slate-100 [&_svg]:tw-pointer-events-none [&_svg]:tw-size-4 [&_svg]:tw-shrink-0 dark:focus:tw-bg-slate-800 dark:data-[state=open]:tw-bg-slate-800",
      inset && "tw-pl-8",
      className
    )}
    {...props}
