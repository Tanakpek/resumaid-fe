...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "tw-rounded-xl tw-border tw-border-slate-200 tw-bg-white tw-text-slate-950 tw-shadow dark:tw-border-slate-800 dark:tw-bg-slate-950 dark:tw-text-slate-50",
      className
    )}
    {...props}
  />
