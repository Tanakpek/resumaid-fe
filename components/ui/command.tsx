...
>(({ className, ...props }, ref) => (
  <div className="tw-flex tw-items-center tw-border-b tw-px-3" cmdk-input-wrapper="">
    ...
    <CommandPrimitive.Input
      ref={ref}
      className={cn(
        "tw-flex tw-h-10 tw-w-full tw-rounded-md tw-bg-transparent tw-py-3 tw-text-sm tw-outline-none placeholder:tw-text-slate-500 disabled:tw-cursor-not-allowed disabled:tw-opacity-50 dark:placeholder:tw-text-slate-400",
        className
      )}
      {...props}
    />
